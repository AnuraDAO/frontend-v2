          ...
          <div className="row align-items-center">
            ...
            <div className="service-img-wrapper col-lg-7 col-md-12 col-sm-12 mt-s">
              <div className="image-box">
                <img draggable="false" src={AnuraWebPlatform} className="center-block img-responsive phone-img" alt="" />
                <img draggable="false" src={AnuraWebRings} className="center-block img-responsive rings " alt="" />
              </div>
            </div> 
          </div>
        </div>
